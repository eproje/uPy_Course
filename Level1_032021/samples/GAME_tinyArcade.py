# SOURCE: https://www.hackster.io/alankrantas/diy-micropython-arcade-esp32-413d9e
# MODIFIED h.serimer 03.2021 https://github.com/eproje/uPy_Course
...
display = SSD1306_I2C(SCREEN_W, SCREEN_H,I2C(scl=Pin(SCL_PIN), sda=Pin(SDA_PIN)))
